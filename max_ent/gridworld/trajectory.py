...
def generate_trajectory_noworld(policy, start, final, p_transition, n_states, max_len=200):
    """
    Generate a single trajectory.
...
def generate_trajectories_noworld(n, policy, start, final, p_transition, n_states, discard_not_feasable=False):
    """
    Generate multiple trajectories.
    ...
    def _generate_one():
        ...
        return generate_trajectory_noworld(policy, s, final, p_transition, n_states)
